...
describe('TaskManager', () => {
    ...
    it('should throw error if teacher is not set when creating task', () => {
        const task = new Task_1.Task('1', 'Religion', 'Assignment', 'Teacher', 'Task 1', 'This is the first task', new Date('2024-11-01'), 'Not started', new Date('2024-10-01'));
        const student = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
    ...
    it('should create and assign a task to a student', () => {
        const task = new Task_1.Task('1', 'English', 'Assignment', 'Teacher', 'Task 1', 'This is the first task', new Date('Deadline: 2024-10-01'), 'Not started', new Date('Created at 2024-09-01'));
        const teacher = new User_1.User('Maria Johnson', 'maria.johnson@lnu.se', 'Teacher');
        const student = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
    ...
    it('should throw error if task with same ID already exists', () => {
        const task = new Task_1.Task('1', 'English', 'Assignment', 'Teacher', 'Task 1', 'This is the first task', new Date('2024-11-01'), 'Not started', new Date('2024-10-01'));
        const teacher = new User_1.User('Maria Johnson', 'maria.johnson@lnu.se', 'Teacher');
        const student = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
        taskManager.assignTaskToStudent(task, teacher, student);
        const newTaskWithSameId = new Task_1.Task('1', 'Math', 'Test', 'Teacher', 'Task 2', 'This is the second task', new Date('2024-11-15'), 'Not started', new Date('2024-10-05'));
    ...
    it('should list all tasks', () => {
        const task1 = new Task_1.Task('1', 'English', 'Assignment', 'Teacher', 'Task 1', 'This is the first task', new Date('2024-10-01'), 'Not started', new Date('2024-09-01'));
        const task2 = new Task_1.Task('2', 'Math', 'Test', 'Teacher', 'Task 2', 'This is the second task', new Date('2024-11-01'), 'In progress', new Date('2024-09-02'));
        const teacher = new User_1.User('Maria Johnson', 'maria.johnson@lnu.se', 'Teacher');
        const student = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
    ...
    it('should update a task successfully', () => {
        const task = new Task_1.Task('1', 'English', 'Assignment', 'Teacher', 'Task 1', 'This is the first task', new Date('2024-10-01'), 'Not started', new Date('2024-09-01'));
        const teacher = new User_1.User('Maria Johnson', 'maria.johnson@lnu.se', 'Teacher');
        const student = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
        taskManager.assignTaskToStudent(task, teacher, student);
        const updatedTask = new Task_1.Task('1', 'Math', 'Test', 'Teacher', 'Updated Task 1', 'Updated description', new Date('2024-11-01'), 'In progress', new Date('2024-09-01'));
    ...
    it('should remind student about unstarted task', () => {
        ...
        const oldTask = new Task_1.Task('2', 'English', 'Assignment', 'Teacher', 'Task 2', 'This is the second task', new Date('2024-10-01'), 'Not started', new Date('2024-08-01'));
        const teacher = new User_1.User('Maria Johnson', 'maria.johnson@lnu.se', 'Teacher');
        const student = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
    ...
    it('should notify student if deadline is within two days', () => {
        ...
        const upcomingTask = new Task_1.Task('3', 'Math', 'Assignment', 'Teacher', 'Task 3', 'This is the third task', new Date(Date.now() + 1 * 24 * 60 * 60 * 1000), 'Not started', new Date(Date.now() - 5 * 24 * 60 * 60 * 1000));
        const teacher = new User_1.User('Maria Johnson', 'maria.johnson@lnu.se', 'Teacher');
        const student = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
        // Assign the task to the student
