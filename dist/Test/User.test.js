...
describe('User', () => {
    let user;
    beforeEach(() => {
        user = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
    });
    it('should generate an id when creating a new user', () => {
        expect(user.userId).toBeDefined();
        console.log('User id generated!', user.userId);
    });
    it('should create a new password and hash it correctly', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should throw an error if the password is less than 8 characters', () => __awaiter(void 0, void 0, void 0, function* () {
        yield expect(user.createPassword('short')).rejects.toThrow('Password must be at least 8 characters long.');
