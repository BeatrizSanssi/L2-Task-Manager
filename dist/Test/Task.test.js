...
describe('Task', () => {
    let task;
    beforeEach(() => {
        task = new Task_1.Task('1', 'English', 'Assignment', 'Teacher', 'Task 1', 'This is the first task', new Date('2024-10-01'), 'Not started', new Date('2024-09-01'));
    });
    ...
    it('should validate task types correctly', () => {
        expect(() => {
            new Task_1.Task('2', 'English', 'InvalidType', 'Teacher', 'Task 2', 'This is the second task', new Date('2024-11-01'), 'Not started', new Date('2024-09-02'));
    ...
    it('should validate task status correctly', () => {
        expect(() => {
            new Task_1.Task('3', 'Math', 'Test', 'Teacher', 'Task 3', 'This is the third task', new Date('2024-12-01'), 'invalid status', new Date('2024-09-03'));
    ...
    it('should throw an error for an empty title', () => {
        expect(() => {
            new Task_1.Task('4', 'History', 'Assignment', 'Teacher', '', 'This task has no title', new Date('2024-10-15'), 'Not started', new Date('2024-09-05'));
        }).toThrow('Title cannot be empty.');
        console.log('Title cannot be empty.');
    });
    it('should throw an error for an invalid deadline', () => {
        expect(() => {
            new Task_1.Task('5', 'Art', 'Project', 'Teacher', 'Task 5', 'This task has an invalid deadline', new Date('invalid-date'), 'Not started', new Date('2024-09-06'));
