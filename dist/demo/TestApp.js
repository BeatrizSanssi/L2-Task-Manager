...
// Create a new user
const user = new User_1.User('Paul Hanson', 'paul.hanson1@student.lnu.se', 'Student');
...
// Create tasks
const task1 = new Task_1.Task('1', 'English', 'Assignment', 'Maria Johnson', 'Essay', 'Write an essay about "Lord of the Flies". The essay must have a minimum of 500 words.', new Date('Deadline: 2024-12-01'), 'Not started', new Date('Created at 2024-09-30'));
console.log('Task created:', task1);
// Create a task manager
const taskManager = new TaskManager_1.TaskManager();
taskManager.assignTaskToStudent(task1, new User_1.User('Maria Johnson', 'maria.Johnson@lnu.com', 'Teacher'), user);
