...
// Create a new user
const user = new User_1.User('id2001', 'Paul', 'Hanson', 'paul.hanson1@student.lnu.se', 'Student');
console.log('User created:', user);
// Create a password for the user
function setupUserPassword() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield user.setPassword('mySecurePassword');
            console.log('Password has been set for:', user.first_name + ' ' + user.last_name);
...
const notificationSystem = new NotificationSystem_1.NotificationSystem('newTask');
...
// Create tasks
const task1 = new Task_1.Task('1', 'English', 'Assignment', 'Maria Johnson', 'Essay', 'Write an essay about "Lord of the Flies". The essay must have a minimum of 500 words.', new Date('Deadline: 2024-12-01'), 'Not started', new Date('Created at 2024-09-30'), 'Not graded');
console.log('Task created:', task1);
// Create a task manager
const taskManager = new TaskManager_1.TaskManager();
taskManager.assignTaskToStudent(task1, new User_1.User('id7T003', 'Maria', 'Johnson', 'maria.Johnson@lnu.com', 'Teacher'), user);
